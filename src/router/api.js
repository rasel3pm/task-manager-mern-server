const { CreateTask, DeleteTask, UpdateTask, ListTaskByStatus,TaskStatusCount } = require("../controller/TasksController")
const { register, login, ProfileUpdate, GetProfile } = require("../controller/UserController")
...
router.post("/DeleteTask/:id",AuthVerification,DeleteTask)
